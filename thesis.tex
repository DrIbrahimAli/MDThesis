...
This study suggests that preoperative NTproBNP levels don't correlate with short -term postoperative outcomes for patients who have good ejection fraction, are not in failure and are undergoing elective isolated CABG surgery. This is supported by similar albeit small-sample studies.  However, the small sample size may result in statistical bias. Therefore, a large-scale study and long-term follow-up should be performed in the future.
